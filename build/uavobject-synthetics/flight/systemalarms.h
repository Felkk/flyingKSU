...
typedef enum { SYSTEMALARMS_ALARM_OUTOFMEMORY=0, SYSTEMALARMS_ALARM_CPUOVERLOAD=1, SYSTEMALARMS_ALARM_STACKOVERFLOW=2, SYSTEMALARMS_ALARM_SYSTEMCONFIGURATION=3, SYSTEMALARMS_ALARM_EVENTSYSTEM=4, SYSTEMALARMS_ALARM_TELEMETRY=5, SYSTEMALARMS_ALARM_MANUALCONTROL=6, SYSTEMALARMS_ALARM_ACTUATOR=7, SYSTEMALARMS_ALARM_ATTITUDE=8, SYSTEMALARMS_ALARM_SENSORS=9, SYSTEMALARMS_ALARM_STABILIZATION=10, SYSTEMALARMS_ALARM_GUIDANCE=11, SYSTEMALARMS_ALARM_PATHPLANNER=12, SYSTEMALARMS_ALARM_BATTERY=13, SYSTEMALARMS_ALARM_FLIGHTTIME=14, SYSTEMALARMS_ALARM_I2C=15, SYSTEMALARMS_ALARM_GPS=16, SYSTEMALARMS_ALARM_BOOTFAULT=17 } SystemAlarmsAlarmElem;

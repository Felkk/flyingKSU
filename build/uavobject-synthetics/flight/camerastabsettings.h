...
// Object constants
#define CAMERASTABSETTINGS_OBJID 0x1CC08C06
...
typedef enum { CAMERASTABSETTINGS_FEEDFORWARD_ROLL=0, CAMERASTABSETTINGS_FEEDFORWARD_PITCH=1, CAMERASTABSETTINGS_FEEDFORWARD_YAW=2 } CameraStabSettingsFeedForwardElem;

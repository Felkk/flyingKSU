...
typedef enum { ATTITUDESIMULATED_VELOCITY_NORTH=0, ATTITUDESIMULATED_VELOCITY_EAST=1, ATTITUDESIMULATED_VELOCITY_DOWN=2 } AttitudeSimulatedVelocityElem;
...
typedef enum { ATTITUDESIMULATED_POSITION_NORTH=0, ATTITUDESIMULATED_POSITION_EAST=1, ATTITUDESIMULATED_POSITION_DOWN=2 } AttitudeSimulatedPositionElem;

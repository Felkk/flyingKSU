 ...
 *
 * Autogenerated files and functions for HwDiscoveryF4 Object
...
// Object constants
#define HWDISCOVERYF4_OBJID 0xAD40F9E0
...
typedef enum { HWDISCOVERYF4_MAINPORT_DISABLED=0, HWDISCOVERYF4_MAINPORT_DEBUGCONSOLE=1 } HwDiscoveryF4MainPortOptions;
// Field USB_HIDPort information
/* Enumeration options for field USB_HIDPort */
typedef enum { HWDISCOVERYF4_USB_HIDPORT_USBTELEMETRY=0, HWDISCOVERYF4_USB_HIDPORT_RCTRANSMITTER=1, HWDISCOVERYF4_USB_HIDPORT_DISABLED=2 } HwDiscoveryF4USB_HIDPortOptions;
// Field USB_VCPPort information
/* Enumeration options for field USB_VCPPort */
typedef enum { HWDISCOVERYF4_USB_VCPPORT_USBTELEMETRY=0, HWDISCOVERYF4_USB_VCPPORT_COMBRIDGE=1, HWDISCOVERYF4_USB_VCPPORT_DEBUGCONSOLE=2, HWDISCOVERYF4_USB_VCPPORT_DISABLED=3 } HwDiscoveryF4USB_VCPPortOptions;

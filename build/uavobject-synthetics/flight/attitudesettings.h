...
typedef enum { ATTITUDESETTINGS_FILTERCHOICE_CCC=0, ATTITUDESETTINGS_FILTERCHOICE_PREMERLANI=1, ATTITUDESETTINGS_FILTERCHOICE_PREMERLANI_GPS=2 } AttitudeSettingsFilterChoiceOptions;

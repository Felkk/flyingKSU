...
// Object constants
#define WAYPOINT_OBJID 0x255CBF84
...
typedef enum { WAYPOINT_MODE_FLYENDPOINT=0, WAYPOINT_MODE_FLYVECTOR=1, WAYPOINT_MODE_FLYCIRCLERIGHT=2, WAYPOINT_MODE_FLYCIRCLELEFT=3, WAYPOINT_MODE_DRIVEENDPOINT=4, WAYPOINT_MODE_DRIVEVECTOR=5, WAYPOINT_MODE_DRIVECIRCLELEFT=6, WAYPOINT_MODE_DRIVECIRCLERIGHT=7, WAYPOINT_MODE_HOLDPOSITION=8, WAYPOINT_MODE_CIRCLEPOSITIONLEFT=9, WAYPOINT_MODE_CIRCLEPOSITIONRIGHT=10, WAYPOINT_MODE_LAND=11, WAYPOINT_MODE_STOP=12 } WaypointModeOptions;

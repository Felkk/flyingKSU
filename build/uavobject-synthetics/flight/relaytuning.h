...
typedef enum { RELAYTUNING_PERIOD_ROLL=0, RELAYTUNING_PERIOD_PITCH=1, RELAYTUNING_PERIOD_YAW=2 } RelayTuningPeriodElem;
...
typedef enum { RELAYTUNING_GAIN_ROLL=0, RELAYTUNING_GAIN_PITCH=1, RELAYTUNING_GAIN_YAW=2 } RelayTuningGainElem;

 ...
 *
 * Autogenerated files and functions for VibrationAnalysisOutput Object
...
static inline int32_t VibrationAnalysisOutputConnectQueue(xQueueHandle queue) { return UAVObjConnectQueue(VibrationAnalysisOutputHandle(), queue, EV_MASK_ALL_UPDATES); }

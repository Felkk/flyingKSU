...
typedef enum { FIXEDWINGPATHFOLLOWERSTATUS_ERROR_BEARING=0, FIXEDWINGPATHFOLLOWERSTATUS_ERROR_SPEED=1, FIXEDWINGPATHFOLLOWERSTATUS_ERROR_ACCEL=2, FIXEDWINGPATHFOLLOWERSTATUS_ERROR_POWER=3 } FixedWingPathFollowerStatusErrorElem;
...
typedef enum { FIXEDWINGPATHFOLLOWERSTATUS_ERRORINT_BEARING=0, FIXEDWINGPATHFOLLOWERSTATUS_ERRORINT_SPEED=1, FIXEDWINGPATHFOLLOWERSTATUS_ERRORINT_ACCEL=2, FIXEDWINGPATHFOLLOWERSTATUS_ERRORINT_POWER=3 } FixedWingPathFollowerStatusErrorIntElem;
...
typedef enum { FIXEDWINGPATHFOLLOWERSTATUS_COMMAND_BEARING=0, FIXEDWINGPATHFOLLOWERSTATUS_COMMAND_SPEED=1, FIXEDWINGPATHFOLLOWERSTATUS_COMMAND_ACCEL=2, FIXEDWINGPATHFOLLOWERSTATUS_COMMAND_POWER=3 } FixedWingPathFollowerStatusCommandElem;
